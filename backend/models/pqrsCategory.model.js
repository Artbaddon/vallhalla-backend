...
class PQRSCategoryModel {
  static async create({ name, description }) {
    try {
      let sqlQuery = `INSERT INTO pqrs_category (PQRS_category_name, PQRS_category_description) VALUES (?, ?)`;
  ...
  static async update(id, { name, description }) {
    try {
      let sqlQuery = `UPDATE pqrs_category SET PQRS_category_name = ?, PQRS_category_description = ? WHERE PQRS_category_id = ?`;
